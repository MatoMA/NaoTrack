...
LIB_DETECTOR = $(LIB)
LDFLAGS_DETECTOR = $(LDFLAGS) -lpthread -lboost_thread-mt -lboost_system-mt -lboost_filesystem-mt -lglog `pkg-config --libs mirage axisPTZ ml-libsvm`
...
out_detector: before_detector $(OBJ_DETECTOR) $(DEP_DETECTOR)
	$(LD) $(LIBDIR_DETECTOR) -o $(OUT_DETECTOR) $(OBJ_DETECTOR)  $(LDFLAGS_DETECTOR) $(LIB_DETECTOR)
